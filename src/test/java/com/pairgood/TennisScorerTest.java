...
public class TennisScorerTest {
    ...
    @Test
    public void receiverWon_GivenAdvantageForty_WhenReceiverWinsPoint_ThenScoreIsFortyForty(){
        TennisScorer scorer = new TennisScorer(TennisScorer.ADVANTAGE, 40);

        Assert.assertEquals("A", scorer.getServerScore());
        Assert.assertEquals("40", scorer.getReceiverScore());
